...
public final class FragmentMovieDetailBinding implements ViewBinding {
  ...
  private FragmentMovieDetailBinding(@NonNull LinearLayout rootView, @NonNull Button buttonFavorite,
  ...
  public static FragmentMovieDetailBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new FragmentMovieDetailBinding((LinearLayout) rootView, buttonFavorite,
