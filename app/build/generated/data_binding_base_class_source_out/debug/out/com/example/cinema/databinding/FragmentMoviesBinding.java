...
public final class FragmentMoviesBinding implements ViewBinding {
  ...
  private FragmentMoviesBinding(@NonNull FrameLayout rootView,
      @NonNull RecyclerView recyclerMovies) {
  ...
  public static FragmentMoviesBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new FragmentMoviesBinding((FrameLayout) rootView, recyclerMovies);
    }
